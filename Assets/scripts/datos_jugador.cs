...
public class datos_jugador : MonoBehaviour
{
    ...
    public float vida_muerte=0;
        ...
        void ReloadScene()
        {
            Scene currentScene/*escena actual*/ = SceneManager.GetActiveScene();//devuelve un objeto de tipo escena
            //en este caso la escena actual es igual = escena que va a ser devuelta

            SceneManager.LoadScene(currentScene.name);// carga la escena y la busca por su nombre
        }
    }
}
